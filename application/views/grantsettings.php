...
<body> 
  ...
  <div class="clearfix">
    ...
    <div class="column left">
                 <h2>GRANT SETTINGS</h2>
        <h3> REGISTER GRANTS</h3>
        <?php echo form_open('index.php/test/insert_grant');?>
         <label>GRANT ID:</label>
          <input type="text" name="grantid" required="required"/>
          <br>
          ...
          <input type="text" name="amountinusd" required="required"/>
           <br>
           <label> SPONSOR:</label>
          <input type="text" name="sponsorer" required="required"/>
           <br>
      ...
      <hr>
        ...
        <h3> UPDATE GRANT</h3>
        <?php echo form_open('index.php/test/update_grant');?>
         <label>GRANT ID:</label>
          <input type="text" name="grantid" required="required"/>
          <br>
          <label> PROJECT NAME:</label>
        ...
        <h3> DELETE GRANT</h3>
        <?php echo form_open('index.php/test/delete_grant');?>
         <label>GRANT ID:</label>
          <input type="text" name="grantid" required="required"/>
