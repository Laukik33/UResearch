...
<head>
	...
	<title>University of Texas at Arlington Research</title>
...
<body> 
  ...
  <ul>
	...
	<div class="clearfix">
		<div class="column rightprofilesettings">
			<nav>	
				<ul>
		...
		<div class="column left set">
			<h2 id="pageheader">Profile Settings</h2>
      <?php echo form_open('index.php/test/profile_query');?>

         <label for="utaid"><b>UTA ID:</b></label>
        <input type="email" name="utaid" >
