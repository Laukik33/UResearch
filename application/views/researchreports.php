...
<body> 
	...
	<div class="clearfix">
		<div class="column rightresearchreports">
			<nav>	
				<ul>
		...
		<div class="column left">
            ...
            <div id = "reports">
            	...
            	<table id = "researchreport" cellpadding="5" border-collapse:collapse>
            		<tbody id = "tbody">
            			<tr id = "tr">
            				<td id  = "td">
            					<p id="link">
            					<a id="report-link" href="http://www.uta.edu/research/vpr/reports/Annual%20Reports/Annual_Report_2016.php" title="2017 Annual Report"> 2017 Annual Report
            					</a>
            				</p>
            			</td>
            			<td id  = "td">
            				<p id="link-right"> To download a printable PDF version click the link. </p>
            			</td>
                              


            			<td id  = "td">
            				<a id="report-link-right" href="http://www.uta.edu/research/vpr/reports/files/AnnualResearchReport2016.pdf" target="_blank">
            					<img id = "pdf" src="<?php echo base_url('assets/Images/pdf.jpg')?>">
            				</a>
            			</td>
            		</tr>
            		<tr id = "tr">
            				<td id  = "td">
            					<p id="link">
            					<a id="report-link" href="http://www.uta.edu/research/vpr/reports/Annual%20Reports/Annual_Report_2015.php" title="2016Annual Report"> 2016 Annual Report
            					</a>
            				</p>
            			</td>
            			<td id  = "td">
            			...
            			<td id  = "td">
            				<a id="report-link-right" href="http://www.uta.edu/research/vpr/reports/Annual%20Reports/Annual_Report_2015.php" target="_blank">
            					<img id = "pdf" src="<?php echo base_url('assets/Images/pdf.jpg')?>">
            				</a>
            			</td>
            		</tr>
            		<tr id = "tr">
            				<td id  = "td">
            					<p id="link">
            					<a id="report-link" href=http://www.uta.edu/research/vpr/reports/Annual%20Reports/Annual_Report_2014.php title="2016Annual Report"> 2015 Annual Report
            					</a>
            				</p>
            			</td>
            			<td id  = "td">
            			...
            			<td id  = "td">
            				<a id="report-link-right" href=http://www.uta.edu/research/vpr/reports/Annual%20Reports/Annual_Report_2014.php" target="_blank">
            					<img id = "pdf" src="<?php echo base_url('assets/Images/pdf.jpg')?>">
            				</a>
            			</td>
            		</tr>
