...
<body> 
	...
	<div class="clearfix">
		...
		<div class="column left">
			...
			<img src = "<?php echo base_url('assets/Images/contact.jpg')?>"><br><br>
            	<p>
				<h3>CONTACT INFORMATION<br></h3></b>
				<p><b>Main Address and Phone</b><br><br>
			
				University of Texas at Arlington<br>
				701 South Nedderman Drive<br>
				Arlington, TX, 76019<br>
				817-272-2011</p><br><br>

				<br>
				<p><b>Help Center<br></b>
				Find links to popular resources and answers to frequently asked questions.<br>

				<p><b>Ask Admissions<br></b>
				General questions about choosing UTA, how to apply, transferring to UTA, campus visits, admissions counselor appointments, and application status.<br>

				<p><b>Ask Financial Aid<br></b>
				Applying for financial aid and scholarships, your financial aid package, and accepting your award.<br><br>

				<b>Ask Records and Registration<br></b>
				Obtaining your transcript, proof of enrollment, audit procedures, and applying for graduation.<br>
