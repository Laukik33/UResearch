...
<body> 
 ...
 <div class = "header">
  ...
  <div class="clearfix">
    <div class="column rightusersettings">
      <nav> 
        <ul>
    ...
    <div class="column left">
                 <h2>USER SETTINGS</h2>
        <h3> REGISTER USER</h3>
         <?php echo form_open('index.php/test/insert_users');?>
         <label>USER ID:</label>
          ...
          <input type="text" name="mobile" required="required"/>
           <br>
          <label>  MAV EMAIL:</label>
          <input type="email" name="email" required="required" />
           <br>


          <label>  UTA ID :</label>
          <input type="text" name="uta_id" required="required" />
           <br>
      ...
      <hr>
        ...
        <h3> UPDATE USER</h3>
        <?php echo form_open('index.php/test/update_users');?>
         <label>USER ID:</label>
          <input type="text" name="userid" required="required"/>
          <br>
        ...
        <h3> DELETE USER</h3>
       <?php echo form_open('index.php/test/delete_users');?>
         <label>USER ID:</label>
          <input type="text" name="userid" required="required"/>
